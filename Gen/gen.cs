...
namespace CbOrm.Gen
{
    ...
    public class CGenTokens : CRflTokens
    {
        ...
        public string Dim_Nsp_Seperator = ".";
...
//            var aFkParentTypeAttributeType = typeof(CbOrm.App.Sys.CForeignKeyCounterpartTypeAttribute).FullName;
  //          var aFkParentTypeAttributeValue = aTargetTypName;
    ...
    public class CCodeDomBuilder
    {
        ...
        public virtual string GetAttributeTypeName(CRflProperty aProperty, string aModelAttributeTypeName, CGenModelInterpreter aModelInterpreter)
            => aModelAttributeTypeName.Contains(aModelInterpreter.Tok.Dim_Nsp_Seperator)
