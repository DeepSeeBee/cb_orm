...
namespace CbOrm.Gen
{
    ...
    public class CGenModelInterpreter : CRflModelInterpreter
    {
        ...
        public virtual string GetR1NCForeignKeyPropertyName(CRflProperty aR1NCProperty) => this.Tok.Trg_P_Parent_Pfx + aR1NCProperty.DeclaringTyp.Name + "_" + aR1NCProperty.Name + this.Tok.Trg_C_Fk_P_Sfx;
        internal IEnumerable<CRflRow> NewR1NCForeignKeyRows(CRflProperty aR1NCProperty)
        {
            ...
            var aFkPropertyRow = CRflRow.New(aFkTypName, aFkPropertyName, this.Tok.MDl_O_A_Typ_Nme, nameof(System.Guid), string.Empty, aGeneratedComment);
            var aFkCounterpartTypeAttributeType = typeof(CForeignKeyCounterpartTypeAttribute).FullName;
            var aFkCounterpartTypeAttributeValue = aSelfTypName;
            var aFkCounterpartTypeAttributeRow = CRflRow.New(aFkTypName, aFkPropertyName, this.Tok.Mdl_P_A_Nme_DomAExst + aFkCounterpartTypeAttributeType, aFkCounterpartTypeAttributeValue, string.Empty, aGeneratedComment);
            var aFkCounterpartPropertyAttributeType = typeof(CForeignKeyCounterpartPropertyNameAttribute).FullName;
            var aFkCounterpartPropertyAttributeValue = aR1NCProperty.Name;
            var aFkCounterpartAttributeRow = CRflRow.New(aFkTypName, aFkPropertyName, this.Tok.Mdl_P_A_Nme_DomAExst + aFkCounterpartPropertyAttributeType, aFkCounterpartPropertyAttributeValue, string.Empty, aGeneratedComment);
        ...
        internal IEnumerable<CRflRow> NewR11CForeignKeyRows(CRflProperty aR11CProperty)                
        {
            ...
            var aFkPropertyRow = CRflRow.New(aSelfTypName, aFkPropertyName, this.Tok.MDl_O_A_Typ_Nme, nameof(System.Guid), string.Empty, aGeneratedComment);
            var aFkCounterpartTypeAttributeType = typeof(CForeignKeyCounterpartTypeAttribute).FullName;
            var aFkCounterpartTypeAttributeValue = aSelfTypName;
            var aFkCounterpartTypeAttributeRow = CRflRow.New(aSelfTypName, aFkPropertyName, this.Tok.Mdl_P_A_Nme_DomAExst + aFkCounterpartTypeAttributeType, aFkCounterpartTypeAttributeValue, string.Empty, aGeneratedComment);
            var aFkCounterpartPropertyNameAttributeType = typeof(CForeignKeyCounterpartPropertyNameAttribute).FullName;
            var aFkParentPropertyAttributeValue = aSelfPropertyName;
            var aFkParentPropertyAttributeRow = CRflRow.New(aSelfTypName, aFkPropertyName, this.Tok.Mdl_P_A_Nme_DomAExst + aFkCounterpartPropertyNameAttributeType, aFkParentPropertyAttributeValue, string.Empty, aGeneratedComment);
            yield return aFkPropertyRow;
            yield return aFkCounterpartTypeAttributeRow;
        ...
        public virtual IEnumerable<CRflRow> NewR1NCReverseNavigationRows(CRflProperty aR1NCProperty)
        {
            ...
            var aFkParentTypeAttributeType = typeof(CForeignKeyCounterpartTypeAttribute).FullName;
            var aFkParentTypeAttributeValue = aTargetTypName;
            var aRefTypDeclRow = CRflRow.New(aTargetTypName, aReverseRefPropertyName, this.Tok.MDl_O_A_Typ_Nme, aReferencedTypName, string.Empty, aGeneratorComment);
            ...
            var aFkPropertyNameAttribType = typeof(CForeignKeyPropertyNameAttribute);
            var aFkPropertyNameAttribValue = aReverseRefPropertyName + "_" + this.Tok.Mdl_T_A_Guid_Nme; // todo - link me
            var aFkPropertyNameAttributeRow = CRflRow.New(aTargetTypName, aReverseRefPropertyName, this.Tok.Mdl_P_A_Nme_DomAExst + aFkPropertyNameAttribType, aFkPropertyNameAttribValue, string.Empty, aGeneratorComment);
            yield return aFkPropertyNameAttributeRow;
    ...
    internal sealed class CCrossReferenceExpander : CModelExpander
    {
        ...
        public override CRflModel Expand(CRflModel aModel)
        {
            ...
            var aNewRows = aR1NCFkRows.Concat(aR1NCRevereRows).Concat(aR11CFkRows).Concat(aOrgRows);
    ...
    public sealed class CCodeGenerator
    {
        ...
        private void AddMembers(CRflTyp aPTyp, CodeTypeDeclaration aCdTypDcl, CRflProperty aProperty)
        {
            ...
            if (aHasRelationObject)
            {
                ...
                var aCtorArgs2 = aCtorArgBuilderAttrib.IsNullRef() ? new CodeExpression[] { } : aCtorArgBuilderAttrib.NewCtorArgs(aModelInterpreter, aCodeDomBuilder, aProperty);
                ...
                var aCtorArgs = aCtorArgs1.Concat(aCtorArgs2);
            ...
            // Property.Attributes
            var aCdAs = this.CodeDomBuilder.NewCodeAttributeDecls(aProperty);
